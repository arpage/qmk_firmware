...
[_COLEMAK] = KEYMAP_TKL(\
      ...
      SPC_LW,    KC_A,      KC_R,   KC_S,   KC_T,   KC_D,   KC_H,   KC_N,   KC_E,   KC_I,    KC_O,    KC_QUOT,         KC_ENT ,                           \
      KC_LSPO,KC_NUBS,KC_Z, KC_X,   KC_C,   KC_V,   KC_B,   KC_K,   KC_M,   KC_COMM, KC_DOT, KC_SLSH,          KC_RSPC,                   KC_UP,          \
      KC_LCTL,KC_LGUI,      KC_LALT,                KC_SPC,                                  MSE,     KC_RGUI, KC_APP, KC_RCTL,  KC_LEFT,KC_DOWN,KC_RGHT
      ),
...
[_DVORAK] = KEYMAP_TKL(\
       ...
       SPC_LW,KC_A,    KC_O,   KC_E,   KC_U,   KC_I,   KC_D,   KC_H,   KC_T,   KC_N,   KC_S,   KC_QUOT,          KC_ENT, \
...
[_LOWER] = KEYMAP_TKL(\
      ...
      KC_TAB,   KC_PGUP,    KC_HOME,   KC_UP,    KC_END,  XXXXXXX,   XXXXXXX,   KC_HOME,   KC_UP,    KC_END,  XXXXXXX, KC_LCBR, KC_RCBR, KC_PIPE,  _______,_______,_______, \
      _______,  KC_PGDN,    KC_LEFT,   KC_DOWN,  KC_RGHT, XXXXXXX,   XXXXXXX,   KC_LEFT,   KC_DOWN,  KC_RGHT, XXXXXXX, _______,          _______,                           \
      _______,XXXXXXX,POINT,PIPE,      KC_LCBR,  KC_LBRC, KC_GRV,    KC_PIPE,   KC_DEL,    KC_PGUP,  KC_PGDN, KC_INS,                    _______,          _______,         \
